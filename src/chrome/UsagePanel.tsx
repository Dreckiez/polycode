...
export function UsagePanel({
  ...
  accountView: "usage" | "accounts" | "add";
  loginView: boolean;
  canManageAccounts: boolean;
  reconnectState: ProviderSignInState;
  reconnectError: string | null;
  resetAction: ResetActionState;
  ...
  onViewChange: (view: "usage" | "accounts" | "add") => void;
  ...
  onConfirmReset: (rowKey: string) => void;
  onCancelReset: () => void;
  onClose: () => void;
}) {
  return accountView === "accounts" && activeAccount ? (
    <ProviderAccountPicker
      providerLabel={providerLabel}
      accounts={accounts}
      accountId={activeAccount.id}
      onBack={() => onViewChange("usage")}
