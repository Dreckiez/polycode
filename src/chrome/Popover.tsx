...
const FRAME =
  "isolate overflow-hidden rounded-xl border border-content/12 bg-background-base shadow-xl";
const BACKDROP =
  "popover-backdrop pointer-events-none absolute inset-0 z-0 [backface-visibility:hidden] [transform:translateZ(0)]";
